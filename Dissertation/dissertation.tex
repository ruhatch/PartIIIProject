...
% Proofs that these form categorical terminal object, product, and exponential
...
The truncated $\SM$ defines all the concepts from \Cref{subsec:setformal}, therefore the following listings contain only auxilliary concepts used in defining the core ones.
...
% Talk about inability to define infinite HITs/coherence conditions and reference Nicolai

% Talk about Nicolai's idea of generalising Favonia's lemma for groupoids and how that might simplify the definitions of monoid-fold etc.

% Talk about any proofs that were still postulated
